...
export default {
  ...
  data() {
    return {
      dsList: [
        { url: 'http://www.dataoke.com/top_sell?type=1', name: '全部', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=4&type=1', name: '居家日用', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=6&type=1', name: '美食', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=2&type=1', name: '母婴', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=3&type=1', name: '美妆', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=1&type=1', name: '女装', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=8&type=1', name: '数码家电', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=7&type=1', name: '文娱车品', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=10&type=1', name: '内衣', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=14&type=1', name: '家装家纺', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=5&type=1', name: '鞋品', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=9&type=1', name: '男装', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=12&type=1', name: '配饰', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=13&type=1', name: '户外运动', list: [] },
        { url: 'http://www.dataoke.com/top_sell?cid=11&type=1', name: '箱包', list: [] },
      ],
      categoryList: [
